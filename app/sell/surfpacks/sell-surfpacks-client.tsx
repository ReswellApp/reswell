  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      await finalizePeerListingCreate({
        listingImpersonation,
        listingFields: buildSurfpackListingPersistFields(payload),
          ...
          <div className="min-w-0 w-full max-w-2xl lg:w-auto lg:max-w-3xl lg:shrink-0">
            ...
            <form onSubmit={handleSubmit} className="space-y-10 lg:space-y-12" aria-busy={submitting}>
              <SellFormSection
                ...
                title="Title & photos"
                description="Write a title in your own words. It's what buyers see first. Add clear photos of your surfpack."
              >
                ...
                <div className="space-y-8">
                  ...
                  {form.shippingAvailable ? (
                    <div className="space-y-4 rounded-xl border border-border bg-card p-5 shadow-sm sm:p-6">
                      ...
                      >
                        <label
                          htmlFor="sell-surfpacks-ship-mode-reswell"
                          className={cn(
                        ...
                        >
                          <RadioGroupItem
                            value="reswell"
                            id="sell-surfpacks-ship-mode-reswell"
                            className="mt-0.5"
                          />
                        ...
                        <label
                          htmlFor="sell-surfpacks-ship-mode-free"
                          className={cn(
                            "flex cursor-pointer gap-3 rounded-lg border p-4 transition-colors",
                        ...
                        >
                          <RadioGroupItem value="free" id="sell-surfpacks-ship-mode-free" className="mt-0.5" />
                          <div className="min-w-0 flex-1 flex-col gap-1.5">
                            <span className="text-sm font-medium leading-snug text-foreground">
                              Offer free shipping
                            </span>
                        ...
                        <label
                          htmlFor="sell-surfpacks-ship-mode-flat"
                          className={cn(
                            "flex cursor-pointer gap-3 rounded-lg border p-4 transition-colors",
                            form.shippingMode === "flat"
                              ? "border-primary bg-primary/5"
                        ...
                        >
                          <RadioGroupItem value="flat" id="sell-surfpacks-ship-mode-flat" className="mt-0.5" />
                          <div className="min-w-0 flex-1 flex-col gap-1.5">
                            <span className="text-sm font-medium leading-snug text-foreground">
