        ...
        <Card>
          <CardContent className="pt-8 pb-8 text-center">
            ...
            <p className="text-muted-foreground text-sm mb-6">
              Card payments are paused while we rebuild payments. Complete checkout with{" "}
              <strong>Reswell Bucks</strong> from the listing page — your receipt appears under Purchases.
            </p>
