...
export default async function PurchasesPage() {
  ...
  const list = (purchases ?? []) as unknown as PurchaseRow[]
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Used gear, surfboards, and other peer-to-peer buys. Shop orders stay under{" "}
          <Link href="/dashboard/orders" className="text-primary underline underline-offset-2">
            Orders
          </Link>
          .
        </p>
