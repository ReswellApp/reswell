...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/used`, lastModified: now, changeFrequency: "daily", priority: 0.8 },
    { url: `${BASE}/used/fins`, lastModified: now, changeFrequency: "daily", priority: 0.7 },
    { url: `${BASE}/used/wetsuits`, lastModified: now, changeFrequency: "daily", priority: 0.7 },
    { url: `${BASE}/used/leashes`, lastModified: now, changeFrequency: "daily", priority: 0.6 },
    { url: `${BASE}/used/board-bags`, lastModified: now, changeFrequency: "daily", priority: 0.6 },
    { url: `${BASE}/used/apparel-lifestyle`, lastModified: now, changeFrequency: "daily", priority: 0.6 },
    { url: `${BASE}/used/collectibles-vintage`, lastModified: now, changeFrequency: "weekly", priority: 0.5 },
    { url: `${BASE}/used/backpacks`, lastModified: now, changeFrequency: "daily", priority: 0.5 },
