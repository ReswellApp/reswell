...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/gear`, lastModified: now, changeFrequency: "daily", priority: 0.8 },
    { url: `${BASE}/fins`, lastModified: now, changeFrequency: "daily", priority: 0.7 },
    { url: `${BASE}/wetsuits`, lastModified: now, changeFrequency: "daily", priority: 0.7 },
    { url: `${BASE}/leashes`, lastModified: now, changeFrequency: "daily", priority: 0.6 },
    { url: `${BASE}/board-bags`, lastModified: now, changeFrequency: "daily", priority: 0.6 },
    { url: `${BASE}/apparel-lifestyle`, lastModified: now, changeFrequency: "daily", priority: 0.6 },
    { url: `${BASE}/collectibles-vintage`, lastModified: now, changeFrequency: "weekly", priority: 0.5 },
    { url: `${BASE}/backpacks`, lastModified: now, changeFrequency: "daily", priority: 0.5 },
