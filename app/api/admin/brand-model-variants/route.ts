...
export async function POST(request: Request) {
  ...
  const result = await createBrandModelVariantService(gate.ctx.supabase, {
    ...
    fin_boxes: parsed.data.fin_boxes,
    material: parsed.data.material,
    condition: parsed.data.condition,
    fin_size: parsed.data.fin_size ?? null,
    configuration_label: parsed.data.configuration_label ?? "",
    fin_base_label: parsed.data.fin_base_label ?? "",
    fin_height_label: parsed.data.fin_height_label ?? "",
    fin_foil_label: parsed.data.fin_foil_label ?? "",
    fin_color_label: parsed.data.fin_color_label ?? "",
