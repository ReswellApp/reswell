...
export function AuthLandingShell({
  ...
  return (
    <div className="relative flex h-svh max-h-svh flex-col overflow-hidden">
      ...
      <main
        className={cn(
          "relative z-10 flex min-h-0 flex-1 justify-center overflow-y-auto",
          isWide
            ? "items-end px-0 pb-0 pt-[max(0.5rem,env(safe-area-inset-top))] sm:items-center sm:px-6 sm:py-4"
