 ...
 *
 * Loaded from the deferred marketing runtime after idle / first interaction, with
 * `lazyOnload` as a second guard so onsite.js stays off the first-paint path.
 */
  ...
  return (
    <>
      <Script
        ...
        strategy="lazyOnload"
      />
      <Script id="klaviyo-onsite-init" strategy="lazyOnload">
        {`
