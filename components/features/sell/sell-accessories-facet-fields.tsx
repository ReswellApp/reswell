...
export function SellAccessoriesFacetFields({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        <div className="space-y-1.5">
          <Label htmlFor="sell-accessory-brand" className="text-xs text-muted-foreground/45">
            Brand
          </Label>
          <Input
        ...
        <div className="space-y-1.5">
          <Label htmlFor="sell-accessory-model" className="text-xs text-muted-foreground/45">
            Model
          </Label>
          <Input
