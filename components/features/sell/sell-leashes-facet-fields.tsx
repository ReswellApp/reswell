...
export type SellLeashesFacetFieldsProps = {
  condition: string
  size: string
  brand: string
  model: string
...
export function SellLeashesFacetFields({
  condition,
  size,
  brand,
  model,
  ...
  onBrandChange,
  onModelChange,
}: SellLeashesFacetFieldsProps) {
  const hasSizeOptions = LEASH_SIZE_OPTIONS.length > 0
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        <SellLeashFacetSelect
          id="sell-leash-condition"
          label="Condition"
          value={condition}
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        <div className="space-y-1.5">
          <Label htmlFor="sell-leash-brand" className="text-xs font-medium text-foreground/85">
            Brand
          </Label>
          <Input
            id="sell-leash-brand"
        ...
        <div className="space-y-1.5">
          <Label htmlFor="sell-leash-model" className="text-xs font-medium text-foreground/85">
            Model
          </Label>
          <Input
            id="sell-leash-model"
