...
export function SellWetsuitsFacetFields({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        <div className="space-y-1.5">
          <Label htmlFor="sell-wetsuit-brand" className="text-xs font-medium text-foreground/85">
            Brand
          </Label>
          <Input
        ...
        <div className="space-y-1.5">
          <Label htmlFor="sell-wetsuit-model" className="text-xs font-medium text-foreground/85">
            Model
          </Label>
          <Input
