      ...
      <Card>
        <CardHeader className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <div className="space-y-1">
            ...
            <CardDescription>
              Flagged marketplace DMs. Email, Venmo/Zelle/Cash App, and phishing are
              blocked before delivery. Phone numbers are allowed for now and are not
              marked as fraud. Gemini confirms fraud or marks innocent wording as not
              fraud. New accounts are permanently banned — including IP and device —
              after 3 phishing / fake-Reswell / click-a-link messages.
            </CardDescription>
          </div>
