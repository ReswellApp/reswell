...
import { SurfpacksBrowseFilterToolbar } from "@/components/surfpacks-browse-filter-toolbar"
...
export function SurfpacksBrowseClient({ children }: { children: ReactNode }) {
