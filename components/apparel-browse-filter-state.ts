...
import {
  ...
  hasAnyApparelFacetSelection,
  type ApparelBrowseFacetSelections,
} from "@/lib/apparel-browse-facets"

const FACET_OWNED_KEYS = [
  ...Object.values(APPAREL_FACET_PARAM_KEYS),
  "brand",
  "minPrice",
  "maxPrice",
] as const

export type ApparelFilterState = {
  searchParams: URLSearchParams
  selections: ApparelBrowseFacetSelections
  brand: string
  minPrice: string
  maxPrice: string
  activeCount: number
...
export function useApparelFilterState(
  ...
  const facetActive = hasAnyApparelFacetSelection(selections)
  const hasAnyActive =
