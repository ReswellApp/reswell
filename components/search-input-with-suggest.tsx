    ...
    <div className={`relative ${className}`} ref={containerRef}>
      ...
      {hasSuggestions && (
        <ul
          ...
          role="listbox"
          className={cn(
            "absolute left-0 right-0 top-full z-50 mt-1.5 overflow-auto rounded-xl border border-border/80 bg-popover text-popover-foreground shadow-lg shadow-black/5",
            "max-h-[280px] py-1",
