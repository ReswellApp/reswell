...
export const ACCESSORY_LISTING_TITLE_MAX_LENGTH = 60
export const ACCESSORY_LISTING_MIN_PHOTOS = 1
export const ACCESSORY_LISTING_MAX_PHOTOS = 12

const accessorySizeValues = ACCESSORY_SIZE_OPTIONS.map((o) => o.value)
...
const accessoryListingImageSchema = z.object({
...
const accessoryListingBaseSchema = z.object({
  title: z.string().trim().min(3, "Add a title").max(ACCESSORY_LISTING_TITLE_MAX_LENGTH),
  ...
  size: optionalSlug(accessorySizeValues),
...
export type CreateAccessoryListingInput = z.infer<typeof accessoryListingBaseSchema>

export const updateAccessoryListingSchema = withAccessoryListingRefinements(accessoryListingUpdateBaseSchema)

export type UpdateAccessoryListingInput = z.infer<typeof accessoryListingUpdateBaseSchema>
