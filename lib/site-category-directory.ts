    ...
    subcategories: [
      {
        heading: "By length",
        links: [
          { label: "6 ft", href: "/used/leashes?leashLength=6" },
          { label: "8 ft", href: "/used/leashes?leashLength=8" },
          { label: "9 ft", href: "/used/leashes?leashLength=9" },
          { label: "10 ft", href: "/used/leashes?leashLength=10" },
        ],
      },
      {
        heading: "By cord thickness",
        links: [
          { label: `3/16"`, href: "/used/leashes?leashThickness=3%2F16" },
          { label: `1/4"`, href: "/used/leashes?leashThickness=1%2F4" },
          { label: `5/16"`, href: "/used/leashes?leashThickness=5%2F16" },
        ],
      },
    ],
  },
