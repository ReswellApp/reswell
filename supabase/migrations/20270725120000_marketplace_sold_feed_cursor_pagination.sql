-- Cursor-paginated confirmed sales for the public /sold feed.
-- Unlike recently_sold_listing_sale_times, this function has no lifetime-result cutoff.
...
COMMENT ON FUNCTION public.marketplace_sold_listing_page(
  ...
  'Cursor-paginated confirmed marketplace sales with no total-result cutoff.';

REVOKE ALL ON FUNCTION public.marketplace_sold_listing_page(
  integer,
  text[],
  timestamptz,
  uuid,
