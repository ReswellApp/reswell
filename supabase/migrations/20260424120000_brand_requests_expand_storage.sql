-- Brand request rows mirror brands catalog fields for admin review; logo in dedicated bucket.
...
COMMENT ON COLUMN public.brand_requests.status IS 'Admin workflow: pending until reviewed; approved/rejected after decision.';

-- Public logos for UGC requests (same MIME limits as brand-assets)
