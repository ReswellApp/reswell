...
The easiest way to reindex: log in as admin, go to **Admin** → **Settings**, and click **Reindex search**. The index is built from all active listings in indexed peer sections (**surfboards**, **fins**, **magazines**, **wetsuits**, **apparel**).
